...
export default function Ceremonia() {
  ...
  return (
    <section className="h-screen w-screen flex flex-col items-center snap-start px-5 py-4 bg-rosa-fondo relative overflow-hidden text-center">
      ...
      <motion.div
        className="w-full max-w-sm sm:max-w-md h-[18rem] sm:h-[20rem] md:h-[22rem] relative rounded-3xl overflow-hidden shadow-xl shrink-0 bg-rosa-fondo border border-dorado-claro/40"
