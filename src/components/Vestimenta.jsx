...
export default function Vestimenta() {
    return (
        <section className="h-screen w-screen flex flex-col justify-center items-center snap-start p-8 bg-white text-center">
            ...
            {/* Icono de gancho de ropa (elegante y minimalista en dorado) */}
            <motion.div
                initial={{ opacity: 0, y: -20 }}
                whileInView={{ opacity: 1, y: 0 }}
                viewport={{ once: true }}
                transition={{ duration: 1 }}
                className="mb-8 text-dorado-principal opacity-90"
            >
            ...
            <motion.h2
                className="text-4xl md:text-5xl font-serif text-rosa-principal mb-8"
                initial={{ opacity: 0, y: 20 }}
                whileInView={{ opacity: 1, y: 0 }}
                viewport={{ once: true }}
            ...
            <motion.div
                ...
                className="border-y border-dorado-claro/80 py-4 px-12"
            >
