...
const destellosRecepcion = [
  { top: '10%', left: '10%', size: 'text-lg', delay: 0 },
  { top: '18%', right: '12%', size: 'text-sm', delay: 1.5 },
  { top: '65%', left: '8%', size: 'text-base', delay: 0.8 },
  { top: '75%', right: '10%', size: 'text-lg', delay: 2.2 },
  { bottom: '8%', left: '22%', size: 'text-sm', delay: 1.1 },
];
